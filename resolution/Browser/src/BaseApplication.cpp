...
void BaseApplication::createFrameListener(void)
{
    ...
    //fux
    this->mDancingGuiSys = new DancingGuiSys(mTrayMgr, mRoot);
    //Label *logoLabel = mTrayMgr->createLabel(OgreBites::TL_TOPLEFT,"logoLabel","",100);
...
{
    this->mDancingGuiSys->keyPressed(arg);
...
{
    this->mDancingGuiSys->keyReleased(arg);
...
{
    this->mDancingGuiSys->mouseMoved(arg);
...
{
    this->mDancingGuiSys->mousePressed(arg,id);
...
{
    this->mDancingGuiSys->mouseReleased(arg,id);
